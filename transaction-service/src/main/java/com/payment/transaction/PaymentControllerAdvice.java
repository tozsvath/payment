...
import com.payment.transaction.model.out.ErrorResponse;
...
public class PaymentControllerAdvice {
  ...
  public ResponseEntity<ErrorResponse> handleConcurrentModificationException(
    ...
    log.error("Concurrently user modification: ", ex);
    return buildErrorResponse("CONCURRENT_MODIFICATION",
        "Concurrent modification occurred, please try again",
        HttpStatus.SERVICE_UNAVAILABLE);
  }
